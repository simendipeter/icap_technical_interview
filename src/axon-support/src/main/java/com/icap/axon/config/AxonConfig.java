package com.icap.axon.config;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.icap.axon.CommandValidatingMessageHandlerInterceptor;
import com.icap.axon.LoggingMessageHandlerInterceptor;
import com.icap.axon.replay.CompositeEventProcessorBuilder;
...
public class AxonConfig {
    ...
    @Bean
    public SimpleCommandBus commandBus(@Qualifier(AxonEventStoreConfig.AXON_AUTO_CONFIG_QUALIFIER) TransactionManager txManager,
