...
class DefaultOrganizationsServiceTest {
    ...
    void createRegisteredOrganisation_WillSendCommandAndWaitForCompletion() {
        var expectedCommand = new CreateRegisteredOrganizationCommand(ORGANIZATION_ID, ADMIN_ID,
                ORGANIZATION_NAME, ORGANIZATION_STREET_1, ORGANIZATION_CITY_1, ORGANIZATION_STATE_1, ORGANIZATION_COUNTRY_1,
                ORGANIZATION_POSTAL_CODE_1, ORGANIZATION_WEBSITE_URL_1, ORGANIZATION_CONTACT_NAME_1, ORGANIZATION_PHONE_NUMBER_1,
                ORG_ADMIN_EMAIL_ADDRESS_1);
        ...
        var newOrgId = defaultOrganizationService.createRegisteredOrganization(ADMIN_ID, ORGANIZATION_NAME, ORGANIZATION_STREET_1,
                ORGANIZATION_CITY_1, ORGANIZATION_STATE_1, ORGANIZATION_COUNTRY_1, ORGANIZATION_POSTAL_CODE_1, ORGANIZATION_WEBSITE_URL_1,
                ORGANIZATION_CONTACT_NAME_1, ORGANIZATION_PHONE_NUMBER_1, ORG_ADMIN_EMAIL_ADDRESS_1);
